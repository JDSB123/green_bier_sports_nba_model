...
Usage:
    python scripts/historical_ingest_elo_ratings.py
    python scripts/historical_ingest_elo_ratings.py --dataset elo_historical
    python scripts/historical_ingest_elo_ratings.py --all
...
# Output directory for ELO data (Azure-only)
ELO_OUTPUT_DIR = resolve_historical_output_root("elo")
