...
class TestTeamNames:
    ...
    def test_normalize_team_name_function(self):
        ...
        # Lakers variants
        assert normalize_team_name("lal").endswith("lal") or "laker" in normalize_team_name("lal").lower()
    ...
    def test_all_30_teams_mapped(self):
        ...
        expected_teams = [
            "nba_atl", "nba_bos", "nba_bkn", "nba_cha", "nba_chi",
            "nba_cle", "nba_dal", "nba_den", "nba_det", "nba_gsw",
            "nba_hou", "nba_ind", "nba_lac", "nba_lal", "nba_mem",
            "nba_mia", "nba_mil", "nba_min", "nba_nop", "nba_nyk",
            "nba_okc", "nba_orl", "nba_phi", "nba_phx", "nba_por",
            "nba_sac", "nba_sas", "nba_tor", "nba_utah", "nba_was",
        ]
