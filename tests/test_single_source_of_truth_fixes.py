...
class TestViolation1InjuryDataFixed:
    ...
    def test_no_fetch_injuries_espn_in_comprehensive(self):
        ...
        comp_file = Path(__file__).parent.parent / "src" / \
            "ingestion" / "comprehensive.py"
...
class TestViolation2TeamNamesFixed:
    ...
    def test_team_factors_consolidated(self):
        ...
        team_factors_file = Path(__file__).parent.parent / \
    ...
    def test_dataset_consolidated(self):
        ...
        dataset_file = Path(__file__).parent.parent / \
...
class TestViolation3OddsFixed:
    ...
    def test_no_fetch_historical_odds_import_in_training_script(self):
        """Verify data_unified_build_training_fresh.py doesn't import fetch_historical_odds"""
        script_file = Path(__file__).parent.parent / \
            "scripts" / "data_unified_build_training_fresh.py"
        ...
        print("✅ Violation #3 FIXED: data_unified_build_training_fresh.py no longer imports fetch_historical_odds")

    def test_uses_unified_fetch_odds(self):
        """Verify data_unified_build_training_fresh.py uses unified fetch_odds"""
        script_file = Path(__file__).parent.parent / \
            "scripts" / "data_unified_build_training_fresh.py"
        with open(script_file, encoding='utf-8', errors='ignore') as f:
            content = f.read()
        ...
        print("✅ Fix #3 VERIFIED: data_unified_build_training_fresh.py uses unified fetch_odds endpoint")
...
class TestNoRegressions:
    ...
    def test_team_factors_can_access_normalize(self):
        ...
        print(
            f"✅ team_factors can use normalize_team_name('bucks') = '{result}'")
