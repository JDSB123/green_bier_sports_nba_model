...
class TestShiftOneLookback:
    ...
    def test_rolling_stats_exclude_current_game(self):
        ...
        game_5_correct = df.iloc[4]["rolling_avg_correct"]  # Should be avg(100,105,110)=105
        game_5_wrong = df.iloc[4]["rolling_avg_wrong"]  # Would be avg(110,115,120)=115
...
class TestTeamCanonicalization:
    ...
    def test_match_key_generation_deterministic(self):
        ...
        key3 = generate_match_key("2025-01-15", "Los Angeles Lakers", "Boston Celtics", source_is_utc=False)
