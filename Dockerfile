...
# Spread filters
ENV FILTER_SPREAD_MIN_CONFIDENCE=0.62
ENV FILTER_SPREAD_MIN_EDGE=2.0
# Total filters
ENV FILTER_TOTAL_MIN_CONFIDENCE=0.72
ENV FILTER_TOTAL_MIN_EDGE=3.0
# 1H spread filters
ENV FILTER_1H_SPREAD_MIN_CONFIDENCE=0.68
ENV FILTER_1H_SPREAD_MIN_EDGE=1.5
# 1H total filters
ENV FILTER_1H_TOTAL_MIN_CONFIDENCE=0.66
ENV FILTER_1H_TOTAL_MIN_EDGE=2.0
