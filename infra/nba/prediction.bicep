// Green Bier Sports - NBA Prediction Models Infrastructure
// Prediction-only entry point (no historical or Teams Bot resources).
//
// Usage:
...
// =============================================================================
// COMPUTE LAYER (Prediction Container App)
// =============================================================================
