...
**Azure Canonical (training_data/latest):**
- Version: `v20260117_175446`
- SHA256: `0eea968d3a42e1b62e654ceb55907e4f8d133b72df2404e822d18328982e91d1`
...
**Archived:**
- `master_training_data.csv` (deprecated) → removed from active workflow; canonical is `data/processed/training_data.csv` (Azure `training_data/latest`).
