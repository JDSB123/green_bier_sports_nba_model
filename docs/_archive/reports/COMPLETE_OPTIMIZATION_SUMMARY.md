...
**Data Source (Updated Canonical):** `data/processed/training_data.csv` mirrored from Azure `training_data/latest/` (3,969 games)

Note: Earlier optimization runs referenced `master_training_data.csv`. That file is now deprecated/archived; the single source of truth is `training_data.csv` (Azure `latest`).
...
### Data Integrity
✅ Canonical data source: `data/processed/training_data.csv` (Azure `training_data/latest/`)
✅ 3,969 games total (2023-01-01 → 2026-01-08)
