...
2. Build Docker image: `docker build -t nbagbsacr.azurecr.io/nba-gbsv-api:NBA_v33.0.10.0 -f Dockerfile.combined .`
3. Push to ACR: `az acr login -n nbagbsacr && docker push nbagbsacr.azurecr.io/nba-gbsv-api:NBA_v33.0.10.0`
4. Deploy to Azure: `az containerapp update -n nba-gbsv-api -g nba-gbsv-model-rg --image nbagbsacr.azurecr.io/nba-gbsv-api:NBA_v33.0.10.0`
...
|----------------|------|-------------|--------|-------|
| `nba-gbsv-api` | Container App | `JDSB123/green_bier_sports_nba_model` | `main` | `nbagbsacr.azurecr.io/nba-gbsv-api:NBA_v33.0.10.0` |
